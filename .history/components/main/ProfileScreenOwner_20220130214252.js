        ...
        <View style={{ flexDirection: "row", marginTop: 15 }}>
          ...
          <View style={{ marginLeft: 20 }}>
            ...
            <Caption style={styles.caption}>
              Place your bio here. What happens if there is a really long bio.
              Like a really really really long bio. And the app has to account
              for this much space. I'm sure there is a feature to implement a
              character limit, but this is for testing purposes.
            </Caption>
          </View>
        </View>
      </View>
