  ...
  if (!onCall) {
    return (
      <MapView
        ...
        style={{ flex: 1 }}
        initialRegion={{
          latitude: (latitude + (targetLatitude != 0 ? targetLatitude : latitude)) / 2, //latitude
          longitude: (longitude + (targetLongitude != 0? targetLongitude : longitude) / 2, //longitude
    ...
    return (
      <MapView
        ...
        style={{ flex: 1 }}
        initialRegion={{
          latitude: (latitude + targetLatitude) / 2, //latitude
          longitude: (longitude + targetLongitude) / 2, //longitude
          // latitudeDelta: 0.0922,
          // longitudeDelta: 0.0421,
          latitudeDelta: 0.122,
          longitudeDelta: 0.0821,
