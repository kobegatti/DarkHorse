    ...
    <>
      <View style={styles.formWrapper}>
        <TextInput
          ...
          value={username}
          onChangeText={(val) => username.setUsername(val)}
        ...
        <TextInput
          ...
          placeholder="Email"
          value={email}
          onChangeText={(val) => email.setEmail(val)}
        ...
        <TextInput
          ...
          value={password}
          onChangeText={(val) => password.setPassword(val)}
        ...
        <TextInput
          ...
          value={password}
          onChangeText={(val) => passwordConfirm.setPasswordConfirm(val)}
          // onChangeText={(val) => this.updateInputValue(val, "password")}
          maxLength={20}
          secureTextEntry={true}
        />
      ...
      <Text>console.log("username" + username);</Text>
    </>
  );
}
// constructor() {
