...
const EmergencyForm = (props) => {
  ...
  async function handleRequest() {
      ...
      .then((snapshot) => {
        snapshot.forEach((request) => {
          ...
          if (typeOfEmergency == "Other") {
            ...
            console.log(breed + " = " + request.breed);
            console.log(typeOfEmergency + " = " + request.typeOfEmergency);
            console.log(auth.currentUser.uid + " = " + request.user_id);
            if (
              breed == request.breed &&
    ...
    console.log("sameRequest = " + sameRequest);
