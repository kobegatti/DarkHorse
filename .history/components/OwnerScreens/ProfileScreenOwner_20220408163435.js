...
const ProfileScreenOwner = (props) => {
  ...
  const [breeds, setBreeds] = useState(toJSArray(currentUser.breeds));
  ...
  const toJSArray = (firebase_arr) => {
    var ret_arr = [];
    for (var i = 0; i < currentUser.breeds.length; i++) {
      ret_arr.push(currentUser.breeds[i]);
      console.log(currentUser.breeds[i]);
    }
        ...
        <View style={{ flexDirection: "row", marginTop: 15 }}>
          ...
          <View style={{ marginLeft: 20 }}>
            ...
            <Caption style={styles.caption}>
              {breeds !== [] ? breeds.join(", ") : "None listed"}
            </Caption>
          </View>
        </View>
      </View>
