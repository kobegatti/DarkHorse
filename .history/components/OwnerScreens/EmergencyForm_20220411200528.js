...
const EmergencyForm = (props) => {
  ...
  function filterOnlineVets(array, fields, value) {
    array = array.filter((item) => {
      const found = fields.every((field, index) => {
        // console.log(item[field]);
        // console.log(value[index]);
        // console.log(item[field] == value[index]);
  ...
  async function handleRequest() {
    ...
    // online_vets = filterOnlineVets(
    //   online_vets,
    //   ["typeOfUser"],
    //   ["Horse Care Professional"]
    // );

    // online_vets = filterOnlineVets(online_vets, ["online"], [true]);

    //console.log(online_vets);
    online_vets = online_vets.filter((item) => {
      return item.data.typeOfUser == "Horse Care Professional";
    });

    console.log(online_vets);

    // online_vets.forEach((item) => {
    //   console.log(item);
    // });
  }
