    ...
    (async () => {
      ...
      db.collection("Users")
        ...
        .update({
          ...
          typeOfUser: auth.currentUser.typeOfUser,
          email: auth.currentUser.email,
          userImg: null,
          breeds: auth.currentUser.breeds,
          bio: auth.currentUser.bio,
          title: auth.currentUser.title,
          workPhone: auth.currentUser.workPhone,
          workEmail: auth.currentUser.workEmail,
          location: auth.currentUser.location,
          online: auth.currentUser.online,
          latitude: latitude,
          longitude: longitude,
        })
