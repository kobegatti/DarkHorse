...
export class Dashboard extends Component {
  ...
  render() {
    const { currentPetOwner } = this.props;
    console.log("user = ", currentPetOwner);
    return (
      <View style={{ flex: 1, justifyContent: "center" }}>
        <Text>{currentPetOwner} is logged in</Text>
...
const mapStateToProps = (store) => ({
  currentPetOwner: store.ownerState.currentPetOwner,
});
